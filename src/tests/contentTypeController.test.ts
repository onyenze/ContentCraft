...
import { ContentType, FieldDefinition } from '../../src/models';
  ...
  describe('GET /api/admin/content-types', () => {
    it('should list all content types', async () => {
      const mockContentTypes = [
        { id: 1, name: 'Article', identifier: 'article', description: 'Blog articles' },
        { id: 2, name: 'Page', identifier: 'page', description: 'Static pages' },
      ];
      
      mockedContentType.findAll.mockResolvedValue(mockContentTypes);
      mockedContentType.count.mockResolvedValue(2);
